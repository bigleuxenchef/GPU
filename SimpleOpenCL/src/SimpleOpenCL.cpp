...
// option -p allow to select the platform IDs
// option -d allow to select the device index in the platform
//		with this option if there are 3 devices 1 cpu and 2 gpu, index 1 when gpu selected
//		means that the second gpu device will be selected
